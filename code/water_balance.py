...
def simulate_water_balance(
    ...
    Inputs:
     ...
     - P                (x,y,t)        daily precipitation timeseries [mm]
     - T                (x,y,t)        daily mean temperature timeseries [C]
     - Ts               (x,y)          snowfall threshold [C]
     - Tm               (x,y)          snowmelt threshold [C]
     - rootDepth_oGS    (x,y,doy)      root depth outside the growing season [mm]
     - rootDepth_GS     (x,y,doy)      root depth during the growing season [mm]
     - awCap            (x,y,doy)      available water capacity [mm/m]
