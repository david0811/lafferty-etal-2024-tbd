...
initial_params = jnp.array([
    awCap_sand, awCap_loamy_sand, awCap_sandy_loam, awCap_silt_loam, awCap_silt, awCap_loam, awCap_sandy_clay_loam, awCap_silty_clay_loam, awCap_clay_loam, awCap_sandy_clay, awCap_silty_clay, awCap_clay, wiltingp_sand, wiltingp_loamy_sand, wiltingp_sandy_loam, wiltingp_silt_loam, wiltingp_silt, wiltingp_loam, wiltingp_sandy_clay_loam, wiltingp_silty_clay_loam, wiltingp_clay_loam, wiltingp_sandy_clay, wiltingp_silty_clay, wiltingp_clay, \
